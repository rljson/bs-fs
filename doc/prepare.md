...
- [Open bs-fs the first time](#open-bs-fs-the-first-time)
  ...
  - [Open bs-fs with Vscode](#open-bs-fs-with-vscode)
...
```bash
git clone https://github.com/rljson/bs-fs.git
```
